(function(wHandle, wjQuery) {
    document.getElementById("server").onchange = function(wHandle) {

            wHandle.connect = wsConnect(document.getElementById("server").value);
    ...
    wHandle.connect = wsConnect("ffa-shc.glitch.me");
    ...
    var delay = 500,
        ...
        scoreText = null,
        skins = {},
        knownNameDict = "8;china;doge;earth;f4;facebook;facepunch;japan;mars;moon;nasa;origin;russia;usa".split(";"),
